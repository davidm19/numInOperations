        ...
        for (i = 0; (i <= 10); i++) {
            switch (i) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println(("Quotient of " 
                                    + (a + (" and " 
                                    + (b + (": " + Integer.toString((a / b))))))));
                    if (((a 
                                == (a + b)) 
                ...
                case 9:
                    System.out.println(("Power of " 
                                    + (a + (" and " 
                                    + (b + (": " + Integer.toString(this.power(a, b))))))));
                    if (((a == this.power(a, b)) 
                                || (b == this.power(a, b)))) {
                        isInRange = true;
                    }
                ...
                case 10:
                    System.out.println(("Power of " 
                                    + (b + (" and " 
                                    + (a + (": " + Integer.toString(this.power(b, a))))))));
                    if (((a == this.power(b, a)) 
                                || (b == this.power(b, a)))) {
                        isInRange = true;
                    }
